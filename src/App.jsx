...
import "./index.css";
        ...
        const HeatmapView = ({ activeMenu }) => {
            ...
            if (activeMenu === 'liquidez') {
                title = "Mapa de Calor: Riesgo de Liquidez";
                gridData = [
                ...
                title = "Mapa de Calor: Riesgo Crediticio";
                gridData = [
                    // Fila 5: Probabilidad Muy Alta
            ...
            } else if (activeMenu === 'mercado') {
                title = "Mapa de Calor: Riesgo de Mercado";
                gridData = [
                    // Fila 5: Probabilidad Muy Alta
                    [{ l: 'Bajo', c: 'bg-green-100 text-green-800 border-green-200' }, { l: 'Bajo', c: 'bg-green-100 text-green-800 border-green-200' }, { l: 'Medio', c: 'bg-yellow-100 text-yellow-800 border-yellow-200' }, { l: 'Alto', c: 'bg-orange-100 text-orange-800 border-orange-200' }, { l: 'Crítico', c: 'bg-red-100 text-red-800 border-red-200' }],
                    // Fila 4: Probabilidad Alta
                    [{ l: 'Bajo', c: 'bg-green-100 text-green-800 border-green-200' }, { l: 'Bajo', c: 'bg-green-100 text-green-800 border-green-200' }, { l: 'Alto', r: 'R2', c: 'bg-orange-100 text-orange-800 border-orange-200 shadow-md transform scale-[1.02] font-bold ring-2 ring-orange-400' }, { l: 'Alto', c: 'bg-orange-100 text-orange-800 border-orange-200' }, { l: 'Crítico', r: 'R1', c: 'bg-red-100 text-red-800 border-red-200 shadow-md transform scale-[1.02] font-bold ring-2 ring-red-400' }],
                    // Fila 3: Probabilidad Media
                    [{ l: 'Bajo', c: 'bg-green-100 text-green-800 border-green-200' }, { l: 'Bajo', c: 'bg-green-100 text-green-800 border-green-200' }, { l: 'Medio', r: 'R4, R5', c: 'bg-yellow-100 text-yellow-800 border-yellow-200 shadow-md transform scale-[1.02] font-bold ring-2 ring-yellow-400' }, { l: 'Alto', r: 'R3', c: 'bg-orange-100 text-orange-800 border-orange-200 shadow-md transform scale-[1.02] font-bold ring-2 ring-orange-400' }, { l: 'Alto', c: 'bg-orange-100 text-orange-800 border-orange-200' }],
                    // Fila 2: Probabilidad Baja
                    [{ l: 'Bajo', c: 'bg-green-100 text-green-800 border-green-200' }, { l: 'Bajo', c: 'bg-green-100 text-green-800 border-green-200' }, { l: 'Bajo', c: 'bg-green-100 text-green-800 border-green-200' }, { l: 'Medio', c: 'bg-yellow-100 text-yellow-800 border-yellow-200' }, { l: 'Alto', c: 'bg-orange-100 text-orange-800 border-orange-200' }],
                    // Fila 1: Probabilidad Muy Baja
                    [{ l: 'Bajo', c: 'bg-green-100 text-green-800 border-green-200' }, { l: 'Bajo', c: 'bg-green-100 text-green-800 border-green-200' }, { l: 'Bajo', c: 'bg-green-100 text-green-800 border-green-200' }, { l: 'Bajo', c: 'bg-green-100 text-green-800 border-green-200' }, { l: 'Medio', c: 'bg-yellow-100 text-yellow-800 border-yellow-200' }]
                ];
            } else if (activeMenu === 'operacional') {
                title = "Mapa de Calor: Riesgo Operacional";
                gridData = [
                    // Fila 5: Probabilidad Muy Alta
                    [{ l: 'Bajo', c: 'bg-green-100 text-green-800 border-green-200' }, { l: 'Bajo', c: 'bg-green-100 text-green-800 border-green-200' }, { l: 'Medio', c: 'bg-yellow-100 text-yellow-800 border-yellow-200' }, { l: 'Alto', c: 'bg-orange-100 text-orange-800 border-orange-200' }, { l: 'Crítico', c: 'bg-red-100 text-red-800 border-red-200' }],
                    // Fila 4: Probabilidad Alta
                    [{ l: 'Bajo', c: 'bg-green-100 text-green-800 border-green-200' }, { l: 'Bajo', c: 'bg-green-100 text-green-800 border-green-200' }, { l: 'Alto', r: 'R2', c: 'bg-orange-100 text-orange-800 border-orange-200 shadow-md transform scale-[1.02] font-bold ring-2 ring-orange-400' }, { l: 'Alto', c: 'bg-orange-100 text-orange-800 border-orange-200' }, { l: 'Crítico', c: 'bg-red-100 text-red-800 border-red-200' }],
                    // Fila 3: Probabilidad Media
                    [{ l: 'Bajo', c: 'bg-green-100 text-green-800 border-green-200' }, { l: 'Bajo', c: 'bg-green-100 text-green-800 border-green-200' }, { l: 'Medio', r: 'R4', c: 'bg-yellow-100 text-yellow-800 border-yellow-200 shadow-md transform scale-[1.02] font-bold ring-2 ring-yellow-400' }, { l: 'Alto', r: 'R1', c: 'bg-orange-100 text-orange-800 border-orange-200 shadow-md transform scale-[1.02] font-bold ring-2 ring-orange-400' }, { l: 'Alto', c: 'bg-orange-100 text-orange-800 border-orange-200' }],
                    // Fila 2: Probabilidad Baja
                    [{ l: 'Bajo', c: 'bg-green-100 text-green-800 border-green-200' }, { l: 'Bajo', c: 'bg-green-100 text-green-800 border-green-200' }, { l: 'Medio', r: 'R5', c: 'bg-yellow-100 text-yellow-800 border-yellow-200 shadow-md transform scale-[1.02] font-bold ring-2 ring-yellow-400' }, { l: 'Alto', r: 'R3', c: 'bg-orange-100 text-orange-800 border-orange-200 shadow-md transform scale-[1.02] font-bold ring-2 ring-orange-400' }, { l: 'Alto', c: 'bg-orange-100 text-orange-800 border-orange-200' }],
                    // Fila 1: Probabilidad Muy Baja
                    [{ l: 'Bajo', c: 'bg-green-100 text-green-800 border-green-200' }, { l: 'Bajo', c: 'bg-green-100 text-green-800 border-green-200' }, { l: 'Bajo', c: 'bg-green-100 text-green-800 border-green-200' }, { l: 'Bajo', c: 'bg-green-100 text-green-800 border-green-200' }, { l: 'Medio', c: 'bg-yellow-100 text-yellow-800 border-yellow-200' }]
                ];
            }
        ...
        const MatrixView = ({ activeMenu }) => {
            ...
            if (activeMenu === 'liquidez') {
                ...
                title = "Matriz de Riesgo de Liquidez";
            } else if (activeMenu === 'crediticio') {
                matrixData = crediticioMatrixData;
                title = "Matriz de Riesgo Crediticio";
            } else if (activeMenu === 'mercado') {
                matrixData = mercadoMatrixData;
                title = "Matriz de Riesgo de Mercado";
            } else if (activeMenu === 'operacional') {
                matrixData = operacionalMatrixData;
            ...
            const conclusiones = [
                {
                    ...
                    title: "Sensibilidad de la liquidez a choques climáticos",
                    text: "La estructura de caja es intrínsecamente vulnerable a factores biológicos y oceanográficos (como el Fenómeno de El Niño). Las variaciones en las cuotas asignadas por PRODUCE generan una alta estacionalidad en los ingresos, creando un riesgo latente de descalce de plazos y estrés de liquidez si un año de baja captura coincide con fuertes vencimientos de deuda.",
                ...
                },
                {
                    ...
                    title: "Exposición a la volatilidad y concentración",
                    text: "Al operar como tomador de precios (price taker), los márgenes dependen fuertemente de la demanda asiática (China) y del precio global de la harina/aceite de pescado. Esta vulnerabilidad se agrava por el riesgo en la estructura de costos, particularmente la volatilidad en precios internacionales del combustible.",
                ...
                {
                    icon: "ph-factory",
                    title: "Impacto operativo en la captura de valor",
                    text: "El riesgo operacional tiene un impacto financiero inmediato. Una falla logística o paralización en planta incrementa costos y degrada rápidamente la calidad de la anchoveta (aumento de histamina). Esto destruye el diferencial de precio, transformando un producto que debió ser Super Prime en calidad estándar.",
                ...
                },
                {
                    ...
                    title: "Riesgo crediticio bidireccional en la cadena",
                    text: "La exposición es atípica y de doble frente: Por un lado, el riesgo internacional de concentración de cartera en grandes traders asiáticos; por el otro, un alto riesgo crediticio local derivado de adelantos de capital de trabajo a armadores de terceros para asegurar el abastecimiento de materia prima.",
            ...
            const recomendaciones = [
                {
                    ...
                    title: "Blindaje de liquidez anticíclico y perfil de deuda",
                    text: "Para mitigar el riesgo climático, Exalmar debe mantener de forma permanente líneas de crédito stand-by irrevocables y estructurar su deuda hacia el largo plazo (emisiones de bonos o créditos sindicados con periodos de gracia). Se recomienda aplicar una política de retención de utilidades conservadora durante años de alta biomasa, constituyendo reservas de caja que garanticen operatividad en escenarios de 'cuota cero'.",
                    color: "border-blue-500",
                    iconColor: "text-blue-600",
                    bgIcon: "bg-blue-100"
                },
                {
                    icon: "ph-chart-polar",
                    title: "Política activa de contabilidad de coberturas (NIIF 9)",
                    text: "Para reducir la volatilidad en el Estado de Resultados y proteger flujos de caja, la gerencia financiera debe utilizar instrumentos derivados (forwards para fijar precios o tipo de cambio, y swaps petroleros/tasas de interés). Es imperativo estructurar estas operaciones bajo criterios de Hedge Accounting, asegurando que actúen como escudos financieros reales y no especulativos.",
                    color: "border-orange-500",
                    iconColor: "text-orange-600",
                    bgIcon: "bg-orange-100"
                },
                {
                    icon: "ph-gear-fine",
                    title: "Mantenimiento Productivo Total (TPM) centrado en calidad",
                    text: "El CapEx debe enfocarse en la confiabilidad de activos críticos, ejecutando planes rigurosos de mantenimiento preventivo durante las vedas para evitar paralizaciones. El control operativo debe orientarse a la velocidad de procesamiento para maximizar la producción de harinas Prime y Super Prime, las cuales ofrecen mayor resistencia ante caídas de precios internacionales.",
                    color: "border-green-500",
                    iconColor: "text-green-600",
                    bgIcon: "bg-green-100"
                },
                {
                    icon: "ph-lock-key",
                    title: "Endurecer control sobre cuentas por cobrar y provisiones",
                    text: "Se debe diversificar los destinos de exportación y exigir Cartas de Crédito confirmadas. En el frente local, es fundamental endurecer la evaluación a armadores terceros, exigiendo garantías prendarias sobre embarcaciones por los adelantos. Además, aplicar modelos rigurosos de Pérdida Crediticia Esperada para reconocer el deterioro de la cartera oportunamente.",
                    color: "border-red-500",
                    iconColor: "text-red-600",
                    bgIcon: "bg-red-100"
                }
